...
def save_excel(df, filename):
    if 'time' in df.columns:
        df['time'] = df['time'].dt.tz_localize(None)  # Remove timezone for Excel
...
if choice == '1':
    save_excel(history_df, "youtube-full-history.xlsx")
